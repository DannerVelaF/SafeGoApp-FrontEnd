...
export default function ChatScreen() {
  const [fontsLoaded] = useFonts({
    ...
    const Item = ({ nombre,ultimoMensaje,activos, mensajes ,  miembros,ultimaPersonaEnEnviarMensaje}) => {
      return(
        <View style={styles.item}>
          ...
          <View style={styles.joinContainer} >
            ...
            <Text style={styles.addText}> {ultimaPersonaEnEnviarMensaje} : {ultimoMensaje}  </Text>
          </View>
          
          <View style={styles.activePersons} >
            <View style={styles.lock}>
            <FontAwesome name="comments" size={15} color="#000" style={styles.icon} />
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.header}>
                ...
                <Text style={styles.CommunityText}>Chats Vecinos</Text>

            <View style={styles.search} id="Search bar">
                <View style={styles.inputContainer}>
                    <TextInput placeholder="Buscar Vecindad " style={styles.buscadorDireccion} />
                    <Image source={search} style={styles.menuIconRight} />
                </View>
            </View>
            </View>
            <Text>     Avisos rápidos, respuesta segura. </Text>
